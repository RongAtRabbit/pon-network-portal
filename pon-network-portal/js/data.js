...
const NEWS_DATA = [
    ...
    {
        id: 'news-011',
        title: '中国联通发布《全光网络白皮书》，勾勒未来网络蓝图',
        source: '中国联通',
        sourceUrl: 'https://www.chinaunicom.com.cn/',
        date: '2026-02-28',
        category: '行业报告',
        summary: '中国联通发布全光网络白皮书，提出构建端到端全光网络的发展目标和实施路径。',
        url: 'detail.html?id=news-011',
        tags: ['中国联通', '白皮书', '全光网络']
    },
    {
        id: 'news-012',
        title: '工业PON市场快速增长，TSN over PON成为热点',
        source: '行业分析',
        sourceUrl: '#',
        date: '2026-02-25',
        category: '市场分析',
        summary: '工业PON市场保持高速增长，TSN over PON技术成为工业场景关注热点。',
